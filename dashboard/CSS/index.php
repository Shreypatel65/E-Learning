...
<body>
    ...
    <div class="col-sm-3"><a href="./video.php"><span title="FSD-I: Lecture 1">
        <div class="card" >
          <img src="css.svg" class="card-img-top" alt="product2" height="400px" width="400px">
          <div class="card-body">
            <h5 class="card-title">Lecture 1</h5>
            <p class="card-text">Contents: Basic CSS tags</p>
          </div>
        </div></a></span>
      </div>
    <div class="col-sm-3"><a href="./video.php"><span title="FSD-I: Lecture 1">
        <div class="card" >
          ...
          <div class="card-body">
            ...
            <p class="card-text">Contents: CSS Colors</p>
          </div>
        </div></a></span>
      </div>
    <div class="col-sm-3"><a href="./video.php"><span title="FSD-I: Lecture 1">
        <div class="card" >
          ...
          <div class="card-body">
            ...
            <p class="card-text">Contents: CSS Backgrounds</p>
          </div>
        </div></a></span>
      </div>
    <div class="col-sm-3"><a href="./video.php"><span title="FSD-I: Lecture 1">
        <div class="card" >
          ...
          <div class="card-body">
            ...
            <p class="card-text">Contents: CSS Pagination</p>
          </div>
        </div></a></span>
      </div>
      </div>
      ...
      <div class="col-sm-3"><a href="./video.php"><span title="FSD-I: Lecture 1">
        <div class="card" >
          ...
          <div class="card-body">
            ...
            <p class="card-text">Contents: CSS Forms</p>
          </div>
        </div></a></span>
      </div>
    </div>
