...
session_start();
$tem = $_SESSION['rollno'];
$one = "SELECT * FROM test1 WHERE rollno=$tem";
$two = "SELECT * FROM test2 WHERE rollno=$tem"; 
$three = "SELECT * FROM test3 WHERE rollno=$tem";
$four = "SELECT * FROM test4 WHERE rollno=$tem";
